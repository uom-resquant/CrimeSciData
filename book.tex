...
\urlstyle{same}
\hypersetup{
  pdftitle={Data Analysis in Crime Science},
  hidelinks,
...
\includegraphics{imgs/mybear.jpg}
...
\includegraphics[width=0.8\textwidth,height=\textheight]{imgs/rstudio.PNG}
...
\includegraphics[width=0.8\textwidth,height=\textheight]{imgs/openscript.PNG}
...
\includegraphics[width=0.8\textwidth,height=\textheight]{imgs/the4views.PNG}
...
\includegraphics[width=0.8\textwidth,height=\textheight]{imgs/newproject.png}
...
\includegraphics[width=0.8\textwidth,height=\textheight]{imgs/consoleresults.PNG}
...
\includegraphics[width=0.8\textwidth,height=\textheight]{imgs/packages.PNG}
...
\includegraphics[width=0.8\textwidth,height=\textheight]{imgs/df.PNG}
...
\includegraphics[width=0.8\textwidth,height=\textheight]{imgs/dataview.PNG}
...
\includegraphics[width=0.8\textwidth,height=\textheight]{imgs/codebook.PNG}
...
\begin{Shaded}
\begin{Highlighting}[]
\FunctionTok{levels}\NormalTok{(HarryPotter}\SpecialCharTok{$}\NormalTok{house\_f) }\CommentTok{\#try \textquotesingle{}levels(HarryPotter$house)\textquotesingle{} and find the difference}
\end{Highlighting}
\end{Shaded}
...
\includegraphics[width=0.8\textwidth,height=\textheight]{imgs/as_factor.png}
...
\begin{Shaded}
\begin{Highlighting}[]
\CommentTok{\#But if you print the frequency distribution you will see the data are still presented in relation to 0 and 1}
...
\begin{Shaded}
\begin{Highlighting}[]
\CommentTok{\#You can use the levels function to see the levels, the categories, in your factor}
...
\CommentTok{\#out to the order of the existing levels. }
\CommentTok{\#So given that 1 is black and black is the second level }
\CommentTok{\#(as shown when printing the results above) you want to make sure that in the c()}
\CommentTok{\#you write black as the second level.}
\FunctionTok{levels}\NormalTok{(banbox}\SpecialCharTok{$}\NormalTok{black\_f) }\OtherTok{\textless{}{-}} \FunctionTok{c}\NormalTok{(}\StringTok{"non{-}Black"}\NormalTok{, }\StringTok{"Black"}\NormalTok{)}
\FunctionTok{table}\NormalTok{(banbox}\SpecialCharTok{$}\NormalTok{black\_f)}
\end{Highlighting}
\end{Shaded}
...
\includegraphics[width=0.8\textwidth,height=\textheight]{imgs/ggpairs.png}
...
\includegraphics{imgs/gesisa.PNG}
...
\includegraphics{imgs/linktoonlinea.png}
...
\includegraphics{imgs/countrya.png}
...
\NormalTok{df }\OtherTok{\textless{}{-}}\NormalTok{ df }\SpecialCharTok{\%\textgreater{}\%} 
    \FunctionTok{mutate}\NormalTok{(}\AttributeTok{region =} \FunctionTok{case\_when}\NormalTok{(isocntry }\SpecialCharTok{\%in\%}\NormalTok{ western\_list }\SpecialCharTok{\textasciitilde{}} \StringTok{"Western"}\NormalTok{, }
\NormalTok{                              isocntry }\SpecialCharTok{\%in\%}\NormalTok{ eastern\_list }\SpecialCharTok{\textasciitilde{}} \StringTok{"Eastern"}\NormalTok{,}
\NormalTok{                              isocntry }\SpecialCharTok{\%in\%}\NormalTok{ northern\_list }\SpecialCharTok{\textasciitilde{}} \StringTok{"Northern"}\NormalTok{, }
\NormalTok{                              isocntry }\SpecialCharTok{\%in\%}\NormalTok{ southern\_list }\SpecialCharTok{\textasciitilde{}} \StringTok{"Southern"}\NormalTok{)}
\NormalTok{           )}
...
\includegraphics{04-carpentry_files/figure-latex/unnamed-chunk-23-1.pdf}
...
\begin{Shaded}
\begin{Highlighting}[]
\NormalTok{df}\SpecialCharTok{$}\NormalTok{occup\_f }\OtherTok{\textless{}{-}} \FunctionTok{as\_factor}\NormalTok{(df}\SpecialCharTok{$}\NormalTok{occupation)}
\FunctionTok{class}\NormalTok{(df}\SpecialCharTok{$}\NormalTok{occup\_f)}
\end{Highlighting}
\end{Shaded}
...
\begin{Shaded}
\begin{Highlighting}[]
\FunctionTok{table}\NormalTok{(df}\SpecialCharTok{$}\NormalTok{occup\_f)}
\end{Highlighting}
\end{Shaded}
...
\begin{Shaded}
\begin{Highlighting}[]
\NormalTok{df}\SpecialCharTok{$}\NormalTok{occup2 }\OtherTok{\textless{}{-}}\NormalTok{ df}\SpecialCharTok{$}\NormalTok{occup\_f}
...
One of the things you need to be very careful with when recoding factors or character variables is that you need to input the chunk of text in the existing variables exactly as they appear in the variable. Otherwise, you will get into trouble. So, for example, if in the code above you wrote \texttt{fishermen} instead of \texttt{Fisherman} you would have 14 fewer cases in the \texttt{Self-Employed} level than you should have. When doing this kind of operation is always convenient to check that the categories add up correctly.
...
\includegraphics{imgs/leftrighta.png}
...
\begin{Shaded}
\begin{Highlighting}[]
\CommentTok{\#option 1: to see labels only}
...
\begin{Shaded}
\begin{Highlighting}[]
\CommentTok{\#option 2: to see labels only}
...
\begin{Shaded}
\begin{Highlighting}[]
\FunctionTok{summary}\NormalTok{(df}\SpecialCharTok{$}\NormalTok{urban)}
\end{Highlighting}
\end{Shaded}
...
\begin{Shaded}
\begin{Highlighting}[]
\NormalTok{df}\SpecialCharTok{$}\NormalTok{urban\_f }\OtherTok{\textless{}{-}} \FunctionTok{as\_factor}\NormalTok{(df}\SpecialCharTok{$}\NormalTok{urban)}
\FunctionTok{attributes}\NormalTok{(df}\SpecialCharTok{$}\NormalTok{urban\_f)}
\end{Highlighting}
\end{Shaded}
...
\begin{Shaded}
\begin{Highlighting}[]
\FunctionTok{levels}\NormalTok{(df}\SpecialCharTok{$}\NormalTok{urban\_f)}
\end{Highlighting}
\end{Shaded}
...
\begin{Shaded}
\begin{Highlighting}[]
\FunctionTok{levels}\NormalTok{(df}\SpecialCharTok{$}\NormalTok{urban\_f)[}\FunctionTok{levels}\NormalTok{(df}\SpecialCharTok{$}\NormalTok{urban\_f) }\SpecialCharTok{==} \StringTok{\textquotesingle{}DK\textquotesingle{}}\NormalTok{] }\OtherTok{\textless{}{-}} \ConstantTok{NA}
\FunctionTok{table}\NormalTok{(df}\SpecialCharTok{$}\NormalTok{urban\_f)}
\end{Highlighting}
\end{Shaded}
...
\begin{Shaded}
\begin{Highlighting}[]
\NormalTok{df}\SpecialCharTok{$}\NormalTok{gender\_f }\OtherTok{\textless{}{-}} \FunctionTok{as\_factor}\NormalTok{(df}\SpecialCharTok{$}\NormalTok{gender)}
\end{Highlighting}
\end{Shaded}
...
\includegraphics{04-carpentry_files/figure-latex/unnamed-chunk-54-1.pdf}
...
\includegraphics{04-carpentry_files/figure-latex/unnamed-chunk-58-1.pdf}
...
\begin{Shaded}
\begin{Highlighting}[]
\FunctionTok{mean}\NormalTok{(df}\SpecialCharTok{$}\NormalTok{politics\_n, }\AttributeTok{na.rm =} \ConstantTok{TRUE}\NormalTok{)}
\end{Highlighting}
\end{Shaded}
...
\begin{Shaded}
\begin{Highlighting}[]
\FunctionTok{median}\NormalTok{(df}\SpecialCharTok{$}\NormalTok{politics\_n, }\AttributeTok{na.rm =} \ConstantTok{TRUE}\NormalTok{)}
\end{Highlighting}
\end{Shaded}
...
\FunctionTok{mlv}\NormalTok{(df}\SpecialCharTok{$}\NormalTok{occup\_f)}
\end{Highlighting}
\end{Shaded}
...
\begin{Shaded}
\begin{Highlighting}[]
\FunctionTok{max}\NormalTok{(df}\SpecialCharTok{$}\NormalTok{politics\_n, }\AttributeTok{na.rm =} \ConstantTok{TRUE}\NormalTok{) }\SpecialCharTok{{-}} \FunctionTok{min}\NormalTok{(df}\SpecialCharTok{$}\NormalTok{politics\_n, }\AttributeTok{na.rm =} \ConstantTok{TRUE}\NormalTok{)}
\end{Highlighting}
\end{Shaded}
...
\begin{Shaded}
\begin{Highlighting}[]
\FunctionTok{var}\NormalTok{(df}\SpecialCharTok{$}\NormalTok{politics\_n, }\AttributeTok{na.rm =} \ConstantTok{TRUE}\NormalTok{)}
\end{Highlighting}
\end{Shaded}
...
\begin{Shaded}
\begin{Highlighting}[]
\FunctionTok{sd}\NormalTok{(df}\SpecialCharTok{$}\NormalTok{politics\_n, }\AttributeTok{na.rm =} \ConstantTok{TRUE}\NormalTok{)}
\end{Highlighting}
\end{Shaded}
...
\NormalTok{effsize}\SpecialCharTok{::}\FunctionTok{cohen.d}\NormalTok{(BCS0708}\SpecialCharTok{$}\NormalTok{tcviolent }\SpecialCharTok{\textasciitilde{}}\NormalTok{ BCS0708}\SpecialCharTok{$}\NormalTok{sex)}
\end{Highlighting}
\end{Shaded}
...
\begin{Shaded}
\begin{Highlighting}[]
\CommentTok{\#step1: create a new object in tabular form because the function we use to compute Goodman and Kruskal\textquotesingle{}s Gamma needs an object of that nature}
...
\CommentTok{\#step2: print the content of this object, and you will see that it is simply the crosstab with just the counts}
...
\includegraphics{08-regression_files/figure-latex/unnamed-chunk-5-1.pdf}
...
\includegraphics{08-regression_files/figure-latex/unnamed-chunk-10-1.pdf}
...
\includegraphics{08-regression_files/figure-latex/unnamed-chunk-11-1.pdf}
...
\includegraphics{08-regression_files/figure-latex/unnamed-chunk-12-1.pdf}
...
\begin{figure}
\centering
\includegraphics{imgs/residual_01.png}
...
\includegraphics{08-regression_files/figure-latex/unnamed-chunk-31-1.pdf}
...
\includegraphics{08-regression_files/figure-latex/unnamed-chunk-32-1.pdf}
...
\includegraphics{08-regression_files/figure-latex/unnamed-chunk-36-1.pdf}
...
\includegraphics{08-regression_files/figure-latex/unnamed-chunk-40-1.pdf}
...
\includegraphics{08-regression_files/figure-latex/unnamed-chunk-41-1.pdf}
...
\includegraphics{09-regression2_files/figure-latex/unnamed-chunk-2-1.pdf}
...
\includegraphics{imgs/respre.png}
...
\includegraphics{imgs/respre2.png}
\includegraphics{imgs/respre3.png}
\includegraphics{imgs/respre4.png}
\includegraphics{imgs/respre5.png}
...
\includegraphics{09-regression2_files/figure-latex/unnamed-chunk-3-1.pdf}
...
\includegraphics{09-regression2_files/figure-latex/unnamed-chunk-4-1.pdf}
...
\includegraphics{09-regression2_files/figure-latex/unnamed-chunk-6-1.pdf}
...
\includegraphics{09-regression2_files/figure-latex/unnamed-chunk-7-1.pdf}
...
\includegraphics{09-regression2_files/figure-latex/unnamed-chunk-9-1.pdf}
...
\includegraphics{09-regression2_files/figure-latex/unnamed-chunk-11-1.pdf}
...
\includegraphics{imgs/SSblog.gif}
...
\includegraphics{09-regression2_files/figure-latex/unnamed-chunk-12-1.pdf}
...
\includegraphics{09-regression2_files/figure-latex/unnamed-chunk-13-1.pdf}
...
\includegraphics{09-regression2_files/figure-latex/unnamed-chunk-16-1.pdf}
...
\includegraphics{09-regression2_files/figure-latex/unnamed-chunk-16-2.pdf}
...
\includegraphics{09-regression2_files/figure-latex/unnamed-chunk-16-3.pdf}
...
\begin{Shaded}
\begin{Highlighting}[]
\FunctionTok{plot}\NormalTok{(}\FunctionTok{allEffects}\NormalTok{(fit\_3q)}\SpecialCharTok{$}\NormalTok{tcarea)}
\end{Highlighting}
\end{Shaded}

\includegraphics{09-regression2_files/figure-latex/unnamed-chunk-19-1.pdf}
...
\includegraphics{09-regression2_files/figure-latex/unnamed-chunk-21-2.pdf}
--\textgreater{}
...
\includegraphics{09-regression2_files/figure-latex/unnamed-chunk-23-1.pdf}
...
\includegraphics{09-regression2_files/figure-latex/unnamed-chunk-24-1.pdf}
...
\includegraphics{09-regression2_files/figure-latex/unnamed-chunk-26-1.pdf}
...
\includegraphics{09-regression2_files/figure-latex/unnamed-chunk-27-1.pdf}
...
\includegraphics{09-regression2_files/figure-latex/unnamed-chunk-29-1.pdf}
...
\includegraphics{09-regression2_files/figure-latex/unnamed-chunk-30-1.pdf}
...
\includegraphics{09-regression2_files/figure-latex/unnamed-chunk-32-1.pdf}
...
\includegraphics{09-regression2_files/figure-latex/unnamed-chunk-38-1.pdf}
...
\includegraphics{10-logistic_files/figure-latex/unnamed-chunk-11-1.pdf}
...
\includegraphics{10-logistic_files/figure-latex/unnamed-chunk-12-1.pdf}
...
\includegraphics{10-logistic_files/figure-latex/unnamed-chunk-13-1.pdf}
...
\includegraphics{10-logistic_files/figure-latex/unnamed-chunk-25-1.pdf}
...
\includegraphics{10-logistic_files/figure-latex/unnamed-chunk-28-1.pdf}
...
\includegraphics{10-logistic_files/figure-latex/unnamed-chunk-29-1.pdf}
